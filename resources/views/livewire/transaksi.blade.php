        ...
        <div class="row mt-2">
            <div class="col-8">
                <div class="card border-primary">
                    <div class="card-body">
                        <h4 classs="card-title"> No Invoice : {{ $transaksiAktif->kode }}</h4>
            ...
            <div class="col-4">
                <div class="card border-primary">
                    <div class="card-body">
                        <h4 classs="card-title">Total Biaya</h4>
                ...
                @if($bayar)
                    @if ($kembalian < 0)
                        <div class="alert alert-danger mt-2" role="alert"> Uang Kurang {{ number_format(abs($kembalian), 2, '.', ',') }} </div> 
                    @elseif ($kembalian > 0)
